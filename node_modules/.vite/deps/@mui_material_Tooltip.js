...
import {
  ...
  useTimeout
} from "./chunk-HB6TNDZD.js";
import {
  ThemeContext,
  _extends,
  init_extends
} from "./chunk-OYPUEHGM.js";
...
var require_useThemeWithoutDefault = __commonJS({
  "node_modules/@mui/system/useThemeWithoutDefault.js"(exports) {
    ...
    function useTheme6(defaultTheme5 = null) {
      const contextTheme = React30.useContext(_styledEngine.ThemeContext);
...
var Grow = React25.forwardRef(function Grow2(props, ref) {
  ...
  return (0, import_jsx_runtime14.jsx)(TransitionComponent, _extends({
    ...
    children: (state, childProps) => {
      return React25.cloneElement(children2, _extends({
        style: _extends({
          opacity: 0,
...
var Tooltip = React29.forwardRef(function Tooltip2(inProps, ref) {
  ...
  const children2 = React29.isValidElement(childrenProp) ? childrenProp : (0, import_jsx_runtime18.jsx)("span", {
    children: childrenProp
  });
  const theme = useTheme4();
  const isRtl = useRtl();
  const [childNode, setChildNode] = React29.useState();
  const [arrowRef, setArrowRef] = React29.useState(null);
  const ignoreNonTouchEvents = React29.useRef(false);
  ...
  if (true) {
    ...
    } = React29.useRef(openProp !== void 0);
    React29.useEffect(() => {
  ...
  const prevUserSelect = React29.useRef();
  ...
  React29.useEffect(() => stopTouchInteraction, [stopTouchInteraction]);
  ...
  const [, setChildIsFocusVisible] = React29.useState(false);
  ...
  const popperRef = React29.useRef();
  ...
  const popperOptions = React29.useMemo(() => {
  ...
  return (0, import_jsx_runtime19.jsxs)(React29.Fragment, {
    children: [React29.cloneElement(children2, childrenProps), (0, import_jsx_runtime18.jsx)(PopperComponent, _extends({
      ...
      }) => (0, import_jsx_runtime18.jsx)(TransitionComponent, _extends({
        timeout: theme.transitions.duration.shorter
      }, TransitionPropsInner, transitionProps, {
        children: (0, import_jsx_runtime19.jsxs)(TooltipComponent, _extends({}, tooltipProps, {
          children: [title, arrow2 ? (0, import_jsx_runtime18.jsx)(ArrowComponent, _extends({}, tooltipArrowProps, {
            ref: setArrowRef
          })) : null]
        }))
      }))
